...
public class NetworkReceiverBlock extends FacingNetworkMemberBlockWithEntity {
    public NetworkReceiverBlock(Settings settings) {
        super(settings);
    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, BlockInit.NETWORK_RECEIVER_BE, (world1, pos, state1, be) -> be.tick(world1, pos, state1));
    }
